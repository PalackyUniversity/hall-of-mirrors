...
VACCINATION_MEAN = 6*4*7  # mean of the vaccination week (in weeks)
VACCINATION_STD = 1*4*7   # standard deviation of the vaccination week (in weeks)
...
HVE_K = 20    # How many weeks to look into the future to see if the subject will die
